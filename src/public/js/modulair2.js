...
const url = 'https://aire-ciudadano-default-rtdb.firebaseio.com/sensors/modulairPm2.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
...
function tabla(data){
    ...
    for (var key in data) {
     ...
     nSerial.innerHTML = nSerial_s[nSerial_s.length-1];
