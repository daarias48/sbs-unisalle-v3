...
let link='CalidAir/CalidAirPM5E1C52104418/Data'
...
const url = 'https://calidair-d27b9-default-rtdb.firebaseio.com/CalidAir/CalidAirPM5E1C52104418/Data.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
...
const downloadExcel = (data) => {
    ...
    saveAsExcel(excelBuffer, 'Mediciones-CalidAir1')
}
