...
const url = 'https://aire-ciudadano-default-rtdb.firebaseio.com/sensors/purpleair.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
