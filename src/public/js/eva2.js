...
const url = 'https://aire-ciudadano-default-rtdb.firebaseio.com/sensors/eva2.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
...
function tabla(data){
    ...
    for (var key in data) {
        ...
        pm25_s.push(data[key].pm25_1);
        pm10_s.push(data[key].pm10_1);
        ...
        storage_s.push(data[key].storage);
        desc_s.push(data[key].description);
        presion_s.push(data[key].pressure);
    ...
    function updateSelect() {
        ...
        switch(measureModulair) {
            ...
            case "2":
                myChart.data.labels = graphDates
                myChart.data.datasets[0].data = presion_s
                myChart.data.datasets[0].borderColor="#56083E"
                myChart.data.datasets[0].backgroundColor="#C72C97"
