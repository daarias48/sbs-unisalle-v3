...
let link='CalidAir/CalidAirPMD37EB9941C20/Data'
...
const url = 'https://calidair-d27b9-default-rtdb.firebaseio.com/CalidAir/CalidAirPMD37EB9941C20/Data.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
...
const downloadExcel = (data) => {
    ...
    saveAsExcel(excelBuffer, 'Mediciones-CalidAir4')
}
