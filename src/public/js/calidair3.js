...
let link='CalidAir/CalidAirPM4BBD9E7CF0AC/Data'
...
const url = 'https://calidair-d27b9-default-rtdb.firebaseio.com/CalidAir/CalidAirPM4BBD9E7CF0AC/Data.json?orderBy=%22id%22&limitToLast=60&print=pretty';
fetch(url)
.then(res => res.json())
.then(data => {   
...
const downloadExcel = (data) => {
    ...
    saveAsExcel(excelBuffer, 'Mediciones-CalidAir3')
}
